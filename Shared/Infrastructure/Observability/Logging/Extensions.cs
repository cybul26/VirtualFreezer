...
namespace VirtualFreezer.Shared.Infrastructure.Observability.Logging;
...
public static class Extensions
{
    ...
    public static IServiceCollection AddLogger(this IServiceCollection services, IConfiguration configuration,
        Action<RequestLoggingMappingConfiguration>?
            configureRequestLoggingMapping)
    {
        ...
        var mappingConfiguration = new RequestLoggingMappingConfiguration();
        configureRequestLoggingMapping?.Invoke(mappingConfiguration);
